package com.blocks.inventory.mapper;
...
import com.blocks.inventory.entity.Message;
...
public interface MessageMapper {
    ...
    @Select("SELECT * FROM t_message WHERE serial_number = #{serialNum}")
    Message findBySerialNum(@Param("serialNum") String serialNum);
}
